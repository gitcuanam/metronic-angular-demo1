...
export function productSpecificationsReducer(state = initialProductSpecificationsState,
                                             action: ProductSpecificationActions): ProductSpecificationsState {
  switch (action.type) {
...
export const getProductSpecificationsState = createFeatureSelector<ProductSpecificationModel>('productSpecifications');
